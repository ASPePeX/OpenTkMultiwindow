...
namespace OpenTkMultiwindow
{
    // Be warned, there is a LOT of stuff here. It might seem complicated, but just take it slow and you'll be fine.
    // OpenGL's initial hurdle is quite large, but once you get past that, things will start making more sense.
    public class WindowYellow : GameWindow
    {
        ...
        public WindowYellow(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
        ...
        protected override void OnLoad()
        {
            ...
            _shader = new Shader("Shaders/shader.vert", "Shaders/shadery.frag");
