...
namespace OpenTkMultiwindow
{
    ...
    public class WindowRed : GameWindow
    {
        ...
        public WindowRed(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
        ...
        protected override void OnLoad()
        {
            ...
            _shader = new Shader("Shaders/shader.vert", "Shaders/shaderr.frag");
